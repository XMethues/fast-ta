...
impl PatternDefinition for CDLBELTHOLDConfig {
    ...
    fn name(&self) -> &'static str { "CDLBELTHOLD" }
    ...
    fn transition(&self, context: &RecognitionContext<'_>, _state: &mut Self::State) -> PatternSignal {
        ...
        { color_signal(context) } else { PatternSignal::NoMatch }
    }
}
...
impl PatternDefinition for CDLCLOSINGMARUBOZUConfig {
    ...
    fn name(&self) -> &'static str { "CDLCLOSINGMARUBOZU" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyLong, CandleSettingType::ShadowVeryShort]
    }
...
define_single_candle_config!(
    ...
    [CandleSettingType::BodyDoji, CandleSettingType::ShadowVeryShort]
);

impl PatternDefinition for CDLDRAGONFLYDOJIConfig {
    type State = ();

    fn name(&self) -> &'static str { "CDLDRAGONFLYDOJI" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyDoji, CandleSettingType::ShadowVeryShort]
    }
    ...
    fn transition(&self, context: &RecognitionContext<'_>, _state: &mut Self::State) -> PatternSignal {
        ...
        { positive_signal() } else { PatternSignal::NoMatch }
    }
}
...
impl PatternDefinition for CDLGRAVESTONEDOJIConfig {
    ...
    fn name(&self) -> &'static str { "CDLGRAVESTONEDOJI" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyDoji, CandleSettingType::ShadowVeryShort]
    }
...
define_single_candle_config!(
    ...
    CDLHIGHWAVEStream,
    [CandleSettingType::BodyShort, CandleSettingType::ShadowVeryLong]
);

impl PatternDefinition for CDLHIGHWAVEConfig {
    type State = ();

    fn name(&self) -> &'static str { "CDLHIGHWAVE" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyShort, CandleSettingType::ShadowVeryLong]
    }
...
impl PatternDefinition for CDLLONGLEGGEDDOJIConfig {
    ...
    fn name(&self) -> &'static str { "CDLLONGLEGGEDDOJI" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyDoji, CandleSettingType::ShadowLong]
    }
...
impl PatternDefinition for CDLLONGLINEConfig {
    ...
    fn name(&self) -> &'static str { "CDLLONGLINE" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyLong, CandleSettingType::ShadowShort]
    }
...
impl PatternDefinition for CDLMARUBOZUConfig {
    ...
    fn name(&self) -> &'static str { "CDLMARUBOZU" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyLong, CandleSettingType::ShadowVeryShort]
    }
...
define_single_candle_config!(
    ...
    [CandleSettingType::BodyDoji, CandleSettingType::ShadowLong, CandleSettingType::Near]
);

impl PatternDefinition for CDLRICKSHAWMANConfig {
    type State = ();

    fn name(&self) -> &'static str { "CDLRICKSHAWMAN" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyDoji, CandleSettingType::ShadowLong, CandleSettingType::Near]
    }
...
impl PatternDefinition for CDLSHORTLINEConfig {
    ...
    fn name(&self) -> &'static str { "CDLSHORTLINE" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyShort, CandleSettingType::ShadowShort]
    }
...
impl PatternDefinition for CDLSPINNINGTOPConfig {
    ...
    fn name(&self) -> &'static str { "CDLSPINNINGTOP" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyShort]
    }
...
define_single_candle_config!(
    ...
    CDLTAKURIStream,
    [CandleSettingType::BodyDoji, CandleSettingType::ShadowVeryShort, CandleSettingType::ShadowVeryLong]
);

impl PatternDefinition for CDLTAKURIConfig {
    type State = ();

    fn name(&self) -> &'static str { "CDLTAKURI" }
    fn settings(&self) -> CandleSettings { self.candle_settings }
    fn referenced_settings(&self) -> &'static [CandleSettingType] {
        &[CandleSettingType::BodyDoji, CandleSettingType::ShadowVeryShort, CandleSettingType::ShadowVeryLong]
    }
